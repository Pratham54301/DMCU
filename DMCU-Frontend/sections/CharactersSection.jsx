...
export default function CharactersSection({ content }) {
  ...
  return (
    <SectionWrapper id="characters">
      <Container>
        <SectionHeading
          eyebrow="Characters"
          title={content?.title || "Icons of light, shadow, and destiny"}
          description={content?.description || "The home page now pulls directly from the DMCU Backend character API, turning this section into a live roster with image-driven cards and direct links into each character profile."}
        />
